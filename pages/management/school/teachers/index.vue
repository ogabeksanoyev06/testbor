<template>
  <div class="grid gap-6">
    <section class="sm:p-4 sm:rounded-xl">
      ...
      <UiTable>
        ...
        <UiTableBody class="font-medium">
          ...
          >
            ...
            <UiTableCell class="">
              <NuxtLink
                :to="{ path: '/management/profile/teacher', query: { userId: item._id } }"
                class="text-primary"
                >{{ item.login }}
              </NuxtLink>
            </UiTableCell>
            <UiTableCell class="" disabled>
              <NuxtLink
                :to="{
                  path: '/management/test-attempt-results/teacher',
            ...
            <UiTableCell class="flex gap-2">
              <ModalTeacherEdit
                :teacherId="item._id"
                @edit-teacher="handleUpdateTeacher"
              />
              <ModalTeacherDelete
                :teacherId="item._id"
