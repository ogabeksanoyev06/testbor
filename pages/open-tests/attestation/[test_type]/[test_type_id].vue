  ...
  <div class="mx-auto  w-full rounded-lg bg-card p-4 shadow-md">
    <VForm @submit="handleSubmitForm" v-slot="{ errors }">
      <div class="grid sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div class="grid gap-2">
          <VField name="attestation_type" rules="required" v-model="form.attestation_type">
            <UiLabel>Attestatsiya turi</UiLabel>
            <UiSelect v-model="form.attestation_type">
        ...
        <div class="grid gap-2">
          <VField name="toifa" rules="required" v-model="form.toifa">
            <UiLabel>Amaldagi toifangiz</UiLabel>
            <UiSelect v-model="form.toifa">
      ...
      <div class="mt-10 flex justify-center">
        <UiButton type="submit" class="w-fit" :loading="loading"> Testni boshlash </UiButton>
      </div>
    </VForm>
  </div>
</template>
