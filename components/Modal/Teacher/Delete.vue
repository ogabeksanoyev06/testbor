...
const emit = defineEmits(['delete-teacher'])
...
const confirmDelete = async () => {
  try {
    loading.value = true
    const response = await deleteTeacher(props.teacherId)
    ...
    <UiDialog v-model:open="isOpen">
      ...
      <UiDialogContent class="sm:max-w-[600px] p-4">
        <div class="pt-6 p-5 flex flex-col items-center">
          ...
          <p class="leading-130 text-gray-700 text-sm">Siz o'qituvchini o'chirmoqchimisiz?</p>
